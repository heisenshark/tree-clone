...
export const treeStylesSchema = z.object({
  ...
  bgType: z.union([z.literal("color"), z.literal("gradient"), z.literal("special")]),
  gradient: z.object({
...
export function stylesFallback(styles: Partial<TreeStylesSchema>) : TreeStylesSchema{
  if(!styles)return {
    textColor: "#000000",
